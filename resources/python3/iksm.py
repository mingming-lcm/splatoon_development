...
def log_in():
    ...
    session_token_code_challenge = "8eSbtl2WOvX5-nVbIZacG3m5CIA6ZknEUCNujJQiKIo"
    parameters = {
        "state":                                "V4XUmfKmAo-o82SuzghAqcwH9bTROGaLiEzebHFToKCyy0fC",
    ...
    header = {
        "User-Agent":   f"Mozilla/5.0 (iPhone; CPU iPhone OS 14_4_2 like Mac OS X)"
    }
...
def get_session_token(session_token_code):
    try:
        ...
        session_token_code_verifier = "8-TY8Gg-FOppmFvNb_r0svaTNd2cEJWZi6EAlRkM9oM"
        parameters = {
            "client_id":                    "71b963c1b7b6d119",
